...
# pretrained_path = 'work_dirs/pretrain_source/co2a_i3d_RG_bs_16_lr_1e-2_ep50_mlp_weights_pretrained_in_16x4/best_top1_acc_epoch_40.pth'
pretrained_path = '/cis/home/kshah/arl/icra_dataset/mmaction2-syn2real/work_dirs/pretrain_source/co2a_i3d_RG_bs_16_lr_1e-2_ep50_mlp_weights_pretrained_in_16x4_v2/best_top1_acc_epoch_40.pth'
...
ann_file_train_source = '/cis/net/io72b/data/kshah/datasets/rocog_v2/annotations/real_ground_train.txt'
ann_file_train_target = '/cis/net/io72b/data/kshah/datasets/rocog_v2/annotations/real_air_train.txt'
ann_file_val = '/cis/net/io72b/data/kshah/datasets/rocog_v2/annotations/real_ground_test.txt'
...
data = dict(
    ...
    test=dict(
        ...
        start_index=0))
evaluation = dict(
    interval=1, metrics=['top_k_accuracy', 'mean_class_accuracy', 'confusion_matrix']) #, gpu_collect=True)
# optimizer
optimizer = dict(
